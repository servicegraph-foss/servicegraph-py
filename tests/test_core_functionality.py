...
class TestCoreServiceRegistration:
    ...
    def test_scoped_registration_basic(self):
        ...
        builder.services.add_factory(ITestService, test_service_factory,
...
class TestNamedServices:
    ...
    def test_named_service_registration(self):
        ...
        builder.services.add_named_factory("primary", ITestService,
                                           lambda p: TestService("Primary service"))
        builder.services.add_named_factory("secondary", ITestService,
                                           lambda p: TestService("Secondary service"))
    ...
    def test_named_service_isolation(self):
        ...
        builder.services.add_singleton(ITestService, TestService)
        builder.services.add_named_factory("special", ITestService,
                                           lambda p: TestService("Special service"))
