...
class UserServiceAzure(IUserServiceAzure):
    ...
    def __init__(self, email_service: Annotated[IEmailServiceAzure, Named("azure_email_service")]):
...
class RequestServiceAzure:
    ...
    def __init__(self, expensive_service: Annotated[ExpensiveServiceAzure, Named("azure_expensive_service")]):
...
class TestAzureFunctionsIntegration:
    ...
    def test_azure_function_service_injection(self):
        ...
        def create_app():
            ...
            builder.services.add_named(
                "azure_email_service", IEmailServiceAzure, EmailServiceAzure,
                ServiceLifetime.SINGLETON
            )
            builder.services.add_named(
                "azure_user_service", IUserServiceAzure, UserServiceAzure,
                ServiceLifetime.SINGLETON
            )
    ...
    def test_azure_function_middleware_pipeline(self):
        ...
        def create_app_with_middleware():
            ...
            builder.services.add_named(
                "azure_logging_middleware", LoggingMiddlewareAzure,
                lifetime=ServiceLifetime.SINGLETON
            )
            builder.services.add_named(
                "azure_auth_middleware", AuthenticationMiddlewareAzure,
                lifetime=ServiceLifetime.SINGLETON
            )
    ...
    def test_azure_function_stateless_optimization(self):
        ...
        def create_optimized_app():
            ...
            builder.services.add_named(
                "azure_expensive_service", ExpensiveServiceAzure,
                lifetime=ServiceLifetime.SINGLETON
            )
            builder.services.add_named(
                "azure_request_service", RequestServiceAzure,
        ...
        for i, app_provider in enumerate(app_instances):
            ...
            assert (request_service1.expensive_service.instance_id
    ...
    def test_azure_function_cold_start_optimization(self):
        ...
        def create_cold_start_app():
            builder = ApplicationBuilder()
            builder.services.add_named(
                "azure_cold_start_service", ColdStartOptimizedServiceAzure,
                lifetime=ServiceLifetime.SINGLETON
            )
            return builder.build()
