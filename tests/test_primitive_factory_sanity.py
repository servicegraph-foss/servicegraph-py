...
class TestFactoryWithPrimitives:
    ...
    def test_add_factory_method(self):
        ...
        builder.services.add_factory(
            MessageService,
            lambda p: MessageService("Via add_factory")
        )
    ...
    def test_add_named_factory(self):
        ...
        builder.services.add_named_factory(
            "primary",
            MessageService,
            lambda p: MessageService("Primary message")
        )
        
        builder.services.add_named_factory(
            "secondary",
            MessageService,
            lambda p: MessageService("Secondary message")
        )
...
class TestFactoryEdgeCases:
    ...
    def test_factory_overrides_default_creation(self):
        ...
        builder.services.add_factory(
            MessageService,
            lambda p: MessageService("Factory override")
        )
    ...
    def test_lambda_factory_shorthand(self):
        ...
        builder.services.add_factory(
            IMessageService,
            lambda p: MessageService("Lambda factory")
        )
