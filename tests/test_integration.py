"""Integration tests for complete dipy workflows."""
...
class TestCompleteWorkflows:
    ...
    def test_multi_tenant_application(self):
        ...
        builder.services.add_named(
            "tenant_a", ITenantService, 
            TenantService,
            ServiceLifetime.SINGLETON
        )
        builder.services.add_named(
            "tenant_b", ITenantService, 
            TenantService,
            ServiceLifetime.SINGLETON
        )
        ...
        builder.services.add_named_factory(
            "tenant_a", ITenantService,
            lambda p: TenantService("tenant_a")
        )
        builder.services.add_named_factory(
            "tenant_b", ITenantService,
            lambda p: TenantService("tenant_b")
        )
