...
class TestPerformanceCharacteristics:
    ...
    def test_service_resolution_performance(self):
        ...
        if first_resolution_time > 0.0001:  # Only check if first resolution was measurable
...
class TestMemoryManagement:
    ...
    def test_scoped_service_cleanup(self):
        ...
        builder.services.add_factory(ScopedServiceWithCleanup, 
    ...
    def test_memory_leak_prevention_with_circular_references(self):
        ...
        builder.services.add_factory(ServiceA, 
                                     lambda p: create_circular_services(p))
        provider = builder.build()
