...
class TestErrorHandling:
    ...
    def test_invalid_scope_usage(self):
        ...
        with pytest.raises(RuntimeError,
                           match="must be used within.*with.*statement"):
...
class TestEdgeCases:
    ...
    @pytest.mark.skip(reason="Generic[T] from typing adds internal parameters that interfere with DI - use concrete classes or factory registration for generics")
