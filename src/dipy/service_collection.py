...
class ServiceCollection:
    ...
    def _validate_implementation_type(self, service_type: Type, implementation: Type, method_name: str = "add") -> None:
        """
    ...
    def add_singleton(self, service_type: Type, implementation: Optional[Type[T]] = None):
        """
        ...
        :raises TypeError: If implementation doesn't implement service_type
        """
        return self.add(service_type, implementation, lifetime=ServiceLifetime.SINGLETON)
    ...
    def add_transient(self, service_type: Type, implementation: Optional[Type[T]] = None):
        """
        ...
        :raises TypeError: If implementation doesn't implement service_type
        """
        return self.add(service_type, implementation, lifetime=ServiceLifetime.TRANSIENT)
    
    def add_factory(self, service_type: Type, factory: Callable[['ServiceProvider'], Any], lifetime: ServiceLifetime = ServiceLifetime.SINGLETON):
        """
    ...
    def add_named(self, name: str, service_type: Type, implementation: Optional[Type[T]] = None, lifetime: ServiceLifetime = ServiceLifetime.SINGLETON):
        """
        Add a named service.
    ...
    def add_named_factory(self, name: str, service_type: Type, factory: Callable[['ServiceProvider'], Any], lifetime: ServiceLifetime = ServiceLifetime.SINGLETON):
        """
    ...
    def add_instance(self, service_type: Type, instance: Any):
        ...
        def instance_factory(provider: 'ServiceProvider') -> Any:
            return instance
        return self.add(service_type, factory=instance_factory, lifetime=ServiceLifetime.SINGLETON)
    ...
    def remove_all_by_type(self, service_type: Type) -> int:
        ...
        keys_to_remove = [
            key for key, reg in self._registrations.items()
    ...
    def _is_primitive_type(self, param_type: Type) -> bool:
        ...
        return param_type in primitive_types or (
            ...
            and param_type.__module__ == 'builtins'
        )

    def _validate_lifecycle_dependency(self, parent_lifetime: ServiceLifetime, dependency_type: Type, 
                                       parent_name: str, param_name: str) -> None:
        """
    ...
    def _create_factory(self, implementation: Type[T], lifetime: ServiceLifetime) -> Callable:
        """
        ...
        try:
            ...
            if hasattr(implementation.__init__, '__qualname__') and implementation.__init__.__qualname__ == 'object.__init__':
        ...
        for param_name, param in sig.parameters.items():
            ...
            self._validate_lifecycle_dependency(lifetime, base_type, implementation.__name__, param_name)
                ...
                try:
                    ...
                    if param_name in named_deps:
                        ...
                        kwargs[param_name] = provider._get_or_create_instance(
                            provider._collection._registrations[f"{provider._get_service_key(base_type)}#{service_name}"],
                            session_id=None,
                            is_dependency=True
                        )
                    else:
